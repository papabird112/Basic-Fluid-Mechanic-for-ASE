// Self-check quiz engine, shared with the departmental courseware template.
// Each page supplies window.QUIZ = { text, questions }; questions are answered
// one at a time and marked immediately, because the point is review, not
// examination. Nothing is stored and nothing leaves the browser.
